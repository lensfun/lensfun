...
# INSTSUBDIR.(module|target) can be used to define an optional install directory suffix
.INSTDIR = $(INSTALL_PREFIX)$(if $(INSTDIR.$2),$(INSTDIR.$2),$(if $(INSTDIR.$1),$(INSTDIR.$1),$3))$(if $(INSTSUBDIR.$2),$(INSTSUBDIR.$2),$(INSTSUBDIR.$1))
